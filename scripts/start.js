...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    const wdsMajor = parseInt(
      require('webpack-dev-server/package.json').version.split('.')[0],
      10
    );
    const devServer =
      wdsMajor >= 4
    ...
    if (typeof devServer.startCallback === 'function') {
      devServer.startCallback(onServerStarted);
    } else {
      devServer.listen(port, HOST, onServerStarted);
    }
